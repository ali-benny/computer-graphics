function main() {
	...
	var tri_vertex = [
		...
		0,
		0,
		1, //colore primo vertice
		1,
		-1,
		-5, // - secondo vertice
		1,
		1,
		0, //colore secondo vertice
		1,
		1,
		-5, // - terzo vertice
		1,
		0,
		0 //colore terzo vertice
	];
	...
	gl.clearDepth(1.0);		//: setta il valore di profondità a cui viene resettato il depth buffer
