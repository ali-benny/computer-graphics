...
Input:
-(arg.1) id - puntatore alla struttura ImageData in cui si vuole disegnare;;
-(arg.2-3) x0, y0 - coordinate primo estremo del linea;
-(arg.4-5) x1, y1 - coordinate secondo estremo della linea;
